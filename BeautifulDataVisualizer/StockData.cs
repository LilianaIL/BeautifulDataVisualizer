...
namespace BeautifulDataVisualizer
{
	public class StockData
	{
		...
		public StockData(string exchange, string stock_symbol, string date, double stock_price_open, double stock_price_high, double stock_price_low, double stock_price_close, double stock_volume, double stock_price_adj_close)
		{
